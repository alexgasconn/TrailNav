...
export function ProfileChart({ profile, height = 72, currentDistance = null, moderateThreshold = 6, steepThreshold = 12 }: Props) {
    ...
    }, [profile, height, currentDistance, moderateThreshold, steepThreshold]);
